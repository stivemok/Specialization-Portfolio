...
class CarRentalForm(FlaskForm):
    ...
    make = StringField('Make(Toyota,Suzuki,Hyundai...)', validators=[DataRequired()], render_kw={"required": True})
    ...
    price = StringField('Price/day', validators=[DataRequired()], render_kw={"required": True})
...
class CarUpdateForm(FlaskForm):
    ...
    price = StringField('Price/day', validators=[DataRequired()])
